...
public class StartPageController {
   ...
   public  TextField UsernameTXT,PasswordTXT,captchaTXT;
    ...
    protected void onLoginBtnClicked(ActionEvent event) throws IOException {
        ...
        if (loginCheckall()) {
            //0 : wrong username    1 : wrong passwoed     2 : ok
            int state=db.isvalid(UsernameTXT.getText(),PasswordTXT.getText());
            switch (state){
                case 2:
                ...
                case 1:
                    Usernametxt.setText("");
                    Passwordtxt.setText("wrong password");
                    break;
                case 0:
                    Passwordtxt.setText("");
                    Usernametxt.setText("wrong username");
            }
    ...
    protected void onSecondSignUpBtnClicked(ActionEvent event)throws IOException{
        ...
        if(signupCheckall()){
            ...
            db.insert("student",nameTXT.getText(),LastnameTXT.getText(),
                    fieldTXT.getText(),usernameTXT.getText(),passwordTXT.getText(),
                    idTXT.getText(),emailTXT.getText(),phoneTXT.getText(),phoneTXT.getText());
